...
print "\n For B-Rho of the d = ",int(1000*$bRhod)/1000," kG cm , what is proton energy? \n";
$Pneeded=($qp * $bRhod)/(10/2.998);
$Eneeded=sqrt($mp*$mp+$Pneeded*$Pneeded)-$mp;
print " = ",int(1000*$Eneeded)/1000," MeV \n";
print " from momemtum = ",int(1000*$Pneeded)/1000," MeV/c) \n";

print "\n For B-Rho of the d = ",int(1000*$bRhod)/1000," kG cm , what is triton energy? \n";
$Pneeded=($qt * $bRhod)/(10/2.998);
$Eneeded=sqrt($mt*$mt+$Pneeded*$Pneeded)-$mt;
print " = ",int(1000*$Eneeded)/1000," MeV \n";
print " from momemtum = ",int(1000*$Pneeded)/1000," MeV/c) \n";

print "\n For B-Rho of the d = ",int(1000*$bRhod)/1000," kG cm , what is alpha energy? \n";
$Pneeded=($qhe4 * $bRhod)/(10/2.998);
$Eneeded=sqrt($mhe4*$mhe4+$Pneeded*$Pneeded)-$mhe4;
print " = ",int(1000*$Eneeded)/1000," MeV \n";
print " from momemtum = ",int(1000*$Pneeded)/1000," MeV/c) \n";
...
#print"\n ",$E," MeV 3He; BRho=",int(1000*$bRhot)/1000," kG cm , equiv proton ",int(1000*$Eneeded)/1000," MeV \n";
